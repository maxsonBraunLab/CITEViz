---
title: "CITEViz: Getting Started"
author: 
  - name: Thai Nguyen
    affiliation: Bioinformatics and Genomics Masters Program, University of Oregon
  - name: Wesley Rosales
    affiliation: Bioinformatics and Genomics Masters Program, University of Oregon
  - name: Anjali Panikar
    affiliation: Bioinformatics and Genomics Masters Program, University of Oregon    
  - name: John Cheney
    affiliation: Bioinformatics and Genomics Masters Program, University of Oregon
  - name: Garth Kong
    affiliation: Knight Cancer Institute, Oregon Health and Science University
...
![](../inst/app/www/clustering-gif.gif)
...
![](../inst/app/www/backgate-b-cells.png)
...
Sample differential expression results for gated cells:

|           | p_val                 | avg_log2FC | pct.1 | pct.2 | p_val_adj             |
|-----------|-----------------------|------------|-------|-------|-----------------------|
| MS4A1     | 3.07822210541376e-279 | 3.17       | 0.983 | 0.03  | 6.38084660231219e-275 |
| CD79A     | 1.99920073907603e-278 | 2.96       | 0.978 | 0.02  | 4.1441432120307e-274  |
| IGHD      | 1.2902084267569e-272  | 3.22       | 0.957 | 0.01  | 2.67447304782438e-268 |
| IGHM      | 9.57252548629278e-266 | 2.50       | 0.985 | 0.08  | 1.98428880805363e-261 |
| BANK1     | 1.21076983581663e-258 | 2.29       | 0.93  | 0.01  | 2.50980479266429e-254 |
| RALGPS2   | 2.69840828875654e-244 | 2.34       | 0.942 | 0.07  | 5.59353054176342e-240 |
| CD79B     | 1.50556981509194e-222 | 2.17       | 0.949 | 0.16  | 3.12089566970409e-218 |
| TYROBP    | 8.83685800947573e-219 | 2.51       | 0.28  | 0.98  | 1.83179229678422e-214 |
| LINC00926 | 1.21423514716165e-216 | 1.65       | 0.828 | 0.02  | 2.51698803655139e-212 |
