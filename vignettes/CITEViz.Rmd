...
To open the interactive CITEViz user interface, use the following command:
...
**Sample data:** In this vignette, we used a 10K cell down-sample of the PBMC dataset from [Hao et. al. 2021](https://doi.org/10.1016/j.cell.2021.04.048). The sample PBMC dataset (in RDS format) for this vignette can be downloaded from Google Drive [here](https://drive.google.com/file/d/1GLRx8KEh_erayt7FhhcWeWR7uyWEVESt/view?usp=sharing).
...
CITEViz gates contain a rich resource of metadata that can facilitate further downstream analyses. In the tutorial below, B-cell and NK-cell clusters are isolated in CITEViz, then re-imported into [Seurat](https://satijalab.org/seurat/) for differential expression analysis.
