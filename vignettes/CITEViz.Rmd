...
```{r, echo = FALSE, out.width = "35%", out.height = "35%"}
...
The test dataset in RDS format and the example gates can be found in the BioConductor 2022 Workshop here: https://github.com/gartician/CITEVizWorkshop/
