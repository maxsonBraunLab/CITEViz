...
knitr::include_graphics("../inst/app/www/qc-unique-adt2.png")
```
...
```{r, echo = FALSE, out.width = "100%", out.height = "125%", fig.align="center"}
knitr::include_graphics("../inst/app/www/clustering_page2.png")
```
...
```{r, echo = FALSE, out.width = "100%", out.height = "125%", fig.align="center"}
knitr::include_graphics("../inst/app/www/clustering_plotly_toolbox.png")
```
...
```{r, echo = FALSE, out.width = "100%", out.height = "125%", fig.align="center"}
# knitr::include_graphics("../inst/app/www/feature_expression_color_matrix.png")

knitr::include_graphics("../inst/app/www/feature_expression_CD14_CD16_2.png")
```
...
1. **Select cells:** When the user’s cursor hovers over each plot on the gating page, a [Plotly](https://plotly-r.com/) toolbox with labeled options will appear. From this toolbox, the user can choose a cell selection tool, zoom, pan, download, and reset a plot by selecting an option. The user can use the box or lasso selection tool to select specific cells in the feature scatter plot. When cells in the feature scatter plot are selected, the corresponding cells in the reduction plot will be highlighted.
...
3. **Click the gate button:** After gating a subset of cells, information about the newly-created gate will be displayed in the [interactive data table](https://rstudio.github.io/DT/) below the plots.

   + **Note:** To rename the selected cell subset after gating, double-click in the Subset_Name area of the data table, type a new name, then press the Tab key or click outside of the table.
...
In the following example, we demonstrate a gate to isolate CD8+ CD4- cells and view the CD8+ T-cell subpopulation:

```{r, echo = FALSE, out.width = "60%", fig.align="center"}
knitr::include_graphics("../inst/app/www/gating_CD8_T_Cells_sidepanel.png")
```

```{r, echo = FALSE, out.width = "100%", out.height = "125%", fig.align="center"}
knitr::include_graphics("../inst/app/www/gating_CD8_T_Cells3.png")
```
...
```{r, echo = FALSE, out.width = "100%", out.height = "125%", fig.align="center"}
knitr::include_graphics("../inst/app/www/backgate-b-cells2.png")
```
...
knitr::include_graphics("../inst/app/www/B-Cells2.png")
```
...
```{r, echo = FALSE, out.width = "100%", out.height = "125%", fig.align="center"}
knitr::include_graphics("../inst/app/www/NK-Cells2.png")
```
