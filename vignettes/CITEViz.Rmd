---
title: "CITEViz: Classify Cell Clusters in CITE-Seq Data using the Flow Cytometry Gating Workflow"
author:
  - name: Garth Kong
    affiliation:
...
vignette: >
  %\VignetteIndexEntry{'Classify Cell Clusters in CITE-Seq Data using the Flow Cytometry Gating Workflow'}
...
![imag_1](citeviz-logo-light-cropped.png)
...
![imag_5](clustering_plotly_toolbox.png)
...
![imag_6](feature_expression_CD8.png)
...
![image_7](feature_expression_CD14_CD16.png)
...
![imag_8](gating_dropdown_menus.png)
...
![imag_9](gate_datatable_renaming.png)
